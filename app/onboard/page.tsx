      ...
      <div className="w-full max-w-2xl">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Step 6: Success & Download Extension */}
            {currentStep === 6 && (
              <div className="text-center">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 mb-8 border-2 border-green-200">
                  ...
                  <p className="text-green-700 mb-4">Just 5 connections per month = <span className="font-bold">${parseInt(formData.price.replace('
            ...
            <div className="flex items-center justify-between mt-10 pt-8 border-t border-slate-200">
              ...
              {currentStep < totalSteps ? (
                <button
                  ...
                  disabled={isLoading}
                  className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-all shadow-lg shadow-blue-600/25 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div className="bg-white/50 rounded-lg p-3">
                      ...
                      <div className="text-lg font-bold text-green-800 mt-1">${parseInt(formData.price.replace('
            ...
            <div className="flex items-center justify-between mt-10 pt-8 border-t border-slate-200">
              ...
              {currentStep < totalSteps ? (
                ...
                <div className="bg-slate-50 rounded-xl p-6 border border-slate-200 text-left">
                  ...
                  <ol className="space-y-3 text-slate-600">
                    <li className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xs mt-0.5">
                        1
                      </div>
                    ...
                    <li className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-6 h-6 bg-green-600 rounded-full flex items-center justify-center text-white font-bold text-xs mt-0.5">
                        ✓
                      </div>
